...
![Teams App with SharePoint page](./images/maturity-model-microsoft365-teams-development/teams-app-sharepoint-page.png)
...
![Teams App with Power Automate flow](./images/maturity-model-microsoft365-teams-development/teams-app-flow-chatbot.png)
...
![Teams Development maturity model sample](./images/maturity-model-microsoft365-teams-development/teams-maturity-model.png)
